"""VAP model variant for two-type backchannel prediction."""
...
class VapGPT_bc_2type(nn.Module):
    """GPT-based VAP model for reactive and emotional backchannels."""
    def __init__(self, conf: Optional[VapConfig] = None):
        """Initialize the two-type backchannel VAP model.
