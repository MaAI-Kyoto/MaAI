"""
This script is an example of using a single microphone with the Timing-only
nodding model (mode="nod_timing"): a single merged nod-occurrence probability
instead of the short/long/long_p breakdown of mode="nod".
"""
